...
Generated 2026-08-29 02:46 UTC by `scripts/test_report.py`. Every test is offline and deterministic.

## Gates

| gate | result |
|---|---|
| pytest | 1046 passed in 5.42s |
| tests total / passed / failed+error / xfail / skipped | 1046 / 1046 / 0 / 0 / 0 |
| total test time | 3.25 s |
| ruff check . | clean |
| claude plugin validate --strict . | pass |
| claude plugin validate --strict skills | pass |
| claude plugin validate --strict agents | pass |
| line coverage (src/portfolio_copilot) | 94.1% |
...
| portfolio/ledger.py | 77 | 0 | 100% |
| portfolio/mapping.py | 78 | 1 | 99% |
...
| test | seconds |
|---|---:|
| test_server_tools::test_tools_list_over_stdio_still_includes_every_pre_existing_tool | 0.648 |
| test_server_tools::test_tools_list_over_stdio_includes_every_new_tool | 0.639 |
| test_cli_and_orders::test_cli_help_lists_commands | 0.251 |
| test_edge_hooks_skills::test_guard_processes_one_megabyte_input_quickly | 0.071 |
| test_edge_hooks_skills::test_guard_denies_accedi_path | 0.059 |
| test_plugin::test_guard_allows_urls_with_keyword_as_bare_substring[https://developer.mozilla.org/en-US/docs/Web/API/Window/sessionStorage] | 0.044 |
| test_plugin::test_guard_tolerates_malformed_input | 0.044 |
| test_plugin::test_guard_allows_local_exports_and_public_data[payload0] | 0.043 |
| test_plugin::test_guard_denies_additional_login_surface_paths[https://mybroker.example.com/portal/dashboard] | 0.043 |
| test_plugin::test_guard_denies_url_with_userinfo_credentials | 0.043 |
...
| test_rejects_bad_price_inputs[prices1-at least two] | ✅ | 0.000 |  |
| test_rejects_bad_price_inputs[prices2-positive] | ✅ | 0.001 |  |
| test_rejects_bad_price_inputs[prices3-positive] | ✅ | 0.001 |  |

### test_cli_and_orders — 7 tests, 0.27 s

| test | status | seconds | note |
|---|---|---:|---|
| test_cli_help_lists_commands | ✅ | 0.251 |  |
| test_cli_parse_missing_file_fails_loudly | ✅ | 0.001 |  |
| test_cli_parse_prints_normalized_portfolio_json | ✅ | 0.015 |  |
...
| test_property_top_up_never_exceeds_target_plus_band[6] | ✅ | 0.001 |  |
...
| test_guard_denies_accedi_path | ✅ | 0.059 |  |
| test_guard_denies_curl_carrying_an_authorization_basic_header | ✅ | 0.038 |  |
| test_guard_denies_signon_path | ✅ | 0.037 |  |
| test_guard_denies_url_with_inline_userinfo_credentials | ✅ | 0.038 |  |
| test_guard_processes_one_megabyte_input_quickly | ✅ | 0.071 |  |
| test_guard_tolerates_empty_stdin | ✅ | 0.038 |  |
| test_guard_tolerates_null_tool_input | ✅ | 0.036 |  |
| test_plugin_marketplace_and_pyproject_versions_all_agree | ✅ | 0.001 |  |
| test_session_banner_exits_zero_and_names_every_skill | ✅ | 0.008 |  |
...
| test_parses_500_rows_within_two_seconds | ✅ | 0.021 |  |
...
| test | status | seconds | note |
|---|---|---:|---|
| test_backtest_accounting_identity_holds_for_random_target_mixes | ✅ | 0.007 |  |
...
| test_backtest_never_sells_implied_units_are_non_decreasing_through_crash_and_recovery | ✅ | 0.008 |  |
...
| test_build_plan_calendar_months_zero_produces_empty_calendar | ✅ | 0.002 |  |
| test_build_plan_calendar_survives_month_end_start_dates_and_review_cadences[1-start_date_0] | ✅ | 0.002 |  |
| test_build_plan_calendar_survives_month_end_start_dates_and_review_cadences[1-start_date_1] | ✅ | 0.002 |  |
| test_build_plan_calendar_survives_month_end_start_dates_and_review_cadences[12-start_date_0] | ✅ | 0.002 |  |
| test_build_plan_calendar_survives_month_end_start_dates_and_review_cadences[12-start_date_1] | ✅ | 0.002 |  |
| test_build_plan_half_year_horizon_with_huge_monthly_contribution_invests_every_month | ✅ | 0.002 |  |
| test_build_plan_half_year_horizon_with_tiny_monthly_contribution_warns_and_never_invents | ✅ | 0.002 |  |
...
| test_annualized_volatility_on_empty_series_returns_none | ✅ | 0.001 |  |
...
| test_evaluate_decisions_respects_min_days_and_marks_unmeasurable | ✅ | 0.001 |  |
...
| test_record_and_load_roundtrip | ✅ | 0.001 |  |
...
| test | status | seconds | note |
|---|---|---:|---|
| test_annualized_volatility_normal_case | ✅ | 0.000 |  |
| test_annualized_volatility_too_few_returns_none | ✅ | 0.000 |  |
| test_concentration | ✅ | 0.000 |  |
| test_max_drawdown | ✅ | 0.000 |  |
...
| test | status | seconds | note |
|---|---|---:|---|
| test_build_plan_growth_profile_with_initial_orders_and_pooling | ✅ | 0.002 |  |
| test_build_plan_rejects_bad_inputs[kwargs0] | ✅ | 0.000 |  |
| test_build_plan_rejects_bad_inputs[kwargs1] | ✅ | 0.000 |  |
| test_build_plan_small_cash_keeps_unallocated_and_warns | ✅ | 0.002 |  |
...
| test_model_portfolios_are_valid_and_sum_to_one | ✅ | 0.002 |  |
...
### test_plugin — 37 tests, 0.94 s

| test | status | seconds | note |
|---|---|---:|---|
| test_architecture_doc_does_not_overclaim_provider_timeouts | ✅ | 0.001 |  |
| test_buy_emitting_skills_invoke_red_team_before_buy_small | ✅ | 0.001 |  |
| test_category_cap_skills_source_every_cap_from_config | ✅ | 0.000 |  |
| test_claude_md_except_exception_convention_matches_code | ✅ | 0.012 |  |
...
| test_guard_allows_local_exports_and_public_data[payload0] | ✅ | 0.043 |  |
| test_guard_allows_local_exports_and_public_data[payload1] | ✅ | 0.041 |  |
| test_guard_allows_local_exports_and_public_data[payload2] | ✅ | 0.041 |  |
...
| test_guard_allows_local_exports_and_public_data[payload5] | ✅ | 0.041 |  |
| test_guard_allows_urls_with_keyword_as_bare_substring[https://api.example.com/v2/authors/12345] | ✅ | 0.042 |  |
| test_guard_allows_urls_with_keyword_as_bare_substring[https://developer.mozilla.org/en-US/docs/Web/API/Window/sessionStorage] | ✅ | 0.044 |  |
| test_guard_allows_urls_with_keyword_as_bare_substring[https://docs.example.org/whitepaper/tokenomics.pdf] | ✅ | 0.042 |  |
| test_guard_denies_additional_login_surface_paths[https://mybroker.example.com/accedi] | ✅ | 0.042 |  |
| test_guard_denies_additional_login_surface_paths[https://mybroker.example.com/portal/dashboard] | ✅ | 0.043 |  |
| test_guard_denies_additional_login_surface_paths[https://mybroker.example.com/signon] | ✅ | 0.041 |  |
| test_guard_denies_auth_surfaces_and_credentials[payload0] | ✅ | 0.034 |  |
| test_guard_denies_auth_surfaces_and_credentials[payload1] | ✅ | 0.035 |  |
| test_guard_denies_auth_surfaces_and_credentials[payload2] | ✅ | 0.037 |  |
| test_guard_denies_auth_surfaces_and_credentials[payload3] | ✅ | 0.040 |  |
| test_guard_denies_auth_surfaces_and_credentials[payload4] | ✅ | 0.037 |  |
| test_guard_denies_auth_surfaces_and_credentials[payload5] | ✅ | 0.034 |  |
| test_guard_denies_auth_surfaces_and_credentials[payload6] | ✅ | 0.036 |  |
| test_guard_denies_credentials_starting_a_non_first_line[payload0] | ✅ | 0.042 |  |
| test_guard_denies_credentials_starting_a_non_first_line[payload1] | ✅ | 0.042 |  |
| test_guard_denies_url_with_userinfo_credentials | ✅ | 0.043 |  |
...
| test_readme_install_command_is_directory_agnostic | ✅ | 0.000 |  |
...
| test_get_stock_snapshot_uses_ttl_cache | ✅ | 0.002 |  |
...
### test_server_capital_auction — 5 tests, 0.01 s

| test | status | seconds | note |
|---|---|---:|---|
| test_capital_auction_raises_tool_error_on_ambiguous_instruments_config | ✅ | 0.000 |  |
| test_corrupted_theses_json_raises_tool_error_not_a_raw_crash | ✅ | 0.006 |  |
| test_map_holdings_to_targets_raises_tool_error_on_ambiguous_instruments_config | ✅ | 0.000 |  |
| test_negative_holding_value_never_crashes_the_auction | ✅ | 0.005 |  |
| test_stock_cap_defaults_conservatively_when_risk_limits_missing | ✅ | 0.000 |  |

### test_server_edge_quality — 6 tests, 0.00 s

| test | status | seconds | note |
|---|---|---:|---|
| test_analyze_stock_evidence_uses_pre_override_snapshot_for_the_cross_check | ✅ | 0.000 |  |
...
| test_log_decision_then_decision_quality_applies_bucket_rubric | ✅ | 0.001 |  |
...
### test_server_portfolio_config — 2 tests, 0.00 s

| test | status | seconds | note |
|---|---|---:|---|
| test_get_portfolio_config_raises_tool_error_on_missing_explicit_path | ✅ | 0.001 |  |
| test_get_portfolio_config_returns_the_repo_example_by_default | ✅ | 0.002 |  |
...
### test_server_propose_replacement — 8 tests, 0.00 s

| test | status | seconds | note |
|---|---|---:|---|
| test_cash_named_candidate_survives_the_full_tool_wiring | ✅ | 0.000 |  |
| test_current_holding_fit_excludes_itself_from_the_exposure_snapshot | ✅ | 0.003 |  |
...
| test_replace_buy_is_capped_by_configured_single_stock_weight | ✅ | 0.000 |  |
| test_replace_buy_within_the_single_stock_cap_still_goes_through | ✅ | 0.000 |  |
...
### test_server_tool_errors — 11 tests, 0.01 s

| test | status | seconds | note |
|---|---|---:|---|
| test_allocate_cash_raises_tool_error_with_message_when_targets_dont_sum_to_one | ✅ | 0.001 |  |
| test_build_investment_plan_raises_tool_error_on_invalid_risk_tolerance | ✅ | 0.003 |  |
...
### test_server_tools — 2 tests, 1.29 s

| test | status | seconds | note |
|---|---|---:|---|
| test_tools_list_over_stdio_includes_every_new_tool | ✅ | 0.639 |  |
| test_tools_list_over_stdio_still_includes_every_pre_existing_tool | ✅ | 0.648 |  |
...
| test_check_thesis_worsened_delta | ✅ | 0.003 |  |
...
| test_load_theses_raises_clear_value_error_on_invalid_schema | ✅ | 0.002 |  |
...
| test_save_thesis_upserts_by_symbol | ✅ | 0.003 |  |
| test_stable_when_no_falsifier_trips_and_no_history | ✅ | 0.000 |  |
| test_status_delta_blackout_after_broken_is_not_improved | ✅ | 0.001 |  |
...
| test_theses_json_is_plain_readable_json | ✅ | 0.002 |  |
...
| test_write_theses_failure_never_corrupts_existing_file | ✅ | 0.003 |  |
| test_write_theses_is_atomic_no_leftover_temp_file | ✅ | 0.002 |  |
